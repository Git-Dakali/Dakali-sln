...
namespace DK.Repositories.GeographicLocation
{
    public class ProvinceRepository : IRepositoryCode<Province>
    {
        ...
        public async Task<IEnumerable<Province>> Get(Country country, CancellationToken cancellation = default)
        {
            ...
            var rows = await _session.Connection.QueryAsync(query, new { CountryId = country.Id}, transaction: _session.Transaction);
        ...
        public async Task<Province> Create(Province entity, CancellationToken cancellation = default)
        {
            ...
            var row = await _session.Connection.QuerySingleAsync(query, new { entity.Code, entity.Name, entity.SearchString, CountryId = entity.Country.Id }, transaction: _session.Transaction);
        ...
        public async Task<Province> Update(Province entity, CancellationToken cancellation = default)
        {
            ...
            entity.SearchString = entity.ToString();
            var row = await _session.Connection.QuerySingleAsync(query, new { entity.Id, entity.Name, entity.SearchString, CountryId = entity.Country.Id}, transaction: _session.Transaction);
